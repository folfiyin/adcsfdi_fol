...
#     base.append(np.mean(x,axis=0))
#     base.append(np.std(x,axis=0))
#     base.append(np.var(x,axis=0))
#     base.append(df1.kurtosis())
#     base.append(df1.skew())
#     base.append(stats.sem(x,axis=0))
#     base.append(stats.median_absolute_deviation(x,axis=0))
#     # base.append(np.sqrt(np.mean(x**2)))
...
# database = pd.concat([data],axis=1)
...
# X_train, X_test, y_train, y_test = train_test_split(X,encoded_Y, test_size=0.2, stratify=y,random_state=0)
...
X_train, X_test, y_train, y_test = train_test_split(X,dummy_y, test_size=0.2, stratify=y,random_state=0)
...
# # plt.show()
# plt.savefig(r'C:\Users\fiyin\OneDrive\Documents\project\Confusion_matrix.svg')
# plt.show()
